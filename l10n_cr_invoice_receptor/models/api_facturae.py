...
def gen_xml_v43(inv, sale_conditions, total_servicio_gravado,
    ...
    for (k, v) in response_json.items():
        ...
        if v.get('impuesto'):
            ...
            sb.Append('<ImpuestoNeto>0.00000</ImpuestoNeto>')
...
def load_xml_data(invoice, load_lines, account_id, product_id=False, analytic_account_id=False):
        ...
        # Se actualiza la fecha contable para que sea la misma que el que está en el XML
        ...
        #     inv.account_id = partner.property_account_payable_id.id
