odoo.define('l10n_cr_electronic_invoice_pos.ClientDetailsEdit', function(require) {
    'use strict';
    ...
    class ClientDetailsEdit extends PosComponent {
        ...
        obtener_nombre(event) {
            ...
            var actividades = result['activity'];
            var str_html = "";
            for(var i = 0; i < actividades.length; i++){
                   str_html += "<option value='" + actividades[i]['id'] + "'>" + actividades[i]['name'] +"</option>";
            }
            var select = document.getElementsByName("activity_id")[0];
